      ...
      <section className="py-12 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-950/30 dark:to-purple-950/30">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="text-2xl font-bold mb-4">免费使用智能科研工具</h2>
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              ...
              <Button asChild size="lg" variant="outline" className="border-2 hover:bg-green-50 dark:hover:bg-green-950/30">
                <Link href="/tools/topic-analysis">
